 ...
 * what white-screened this custom pipeline (log depth + WGSL OCBT material + star
 ...
 * renderer (velocity buffer) which is incompatible with the OCBT GPU-driven
 ...
 * matrix and propagates to the OCBT material automatically through
