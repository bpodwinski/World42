// TERRAIN EvaluateLEB pass (one thread per pool slot). Decodes each live slot's u64
// heap id to its three unit-sphere corners (REFERENCE leb convention, terrain_eval_leb)
...
//
// Composed after: engineWgslPreamble + terrain_u64.wgsl + terrain_eval_leb.wgsl + common.
