// TERRAIN pool decode validation — runs the WGSL decode_bit / decode_bit_complement on
...
//
// Output layout (decodeOut, length TERRAIN_CAPACITY): indices [0, nAlloc) hold
// decode_bit(i) (i-th allocated slot); indices [nAlloc, TERRAIN_CAPACITY) hold
