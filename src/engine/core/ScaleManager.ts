...
/**
 * ScaleManager class for converting real-world distances (in kilometers) to simulation units used in Babylon.js
 */
export class ScaleManager {
    private static readonly SCALE_FACTOR = Number(process.env.SCALE_FACTOR || 1);
