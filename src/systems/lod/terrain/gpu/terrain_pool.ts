/**
 * TERRAIN pool constants & layout helpers (shared by the TS mirror, the GPU buffer
 * sizing, and — via codegen — the WGSL). The TERRAIN (Benyoub & Dupuy, HPG 2024) uses
